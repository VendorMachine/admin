<template>
  <div>
    ...
    <div>
      ...
      <section class="flex flex-wrap p-4 " v-if="!$fetchState.pending && !busyPaging">
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      setPage(page) {
        if (this.busyPaging) {return false}
        this.busyPaging = true
        return this.vendorsList({ page })
        .finally(() => {
          this.busyPaging = false
        })
      }
    },
